...
<div align="center">
  <div style="display:inline-block; padding:26px 34px; margin:10px 0 18px; border:1px solid rgba(103,232,249,0.24); border-radius:26px; background:linear-gradient(135deg, rgba(2,6,23,0.98), rgba(15,23,42,0.95)); box-shadow:0 0 40px rgba(0,217,255,0.20);">
    <h1 style="margin:0 0 12px; font-family:'Segoe UI', 'Trebuchet MS', Arial, sans-serif; font-size:50px; font-weight:900; letter-spacing:3px; line-height:1.05; background:linear-gradient(90deg, #67e8f9 0%, #818cf8 48%, #f0abfc 100%); -webkit-background-clip:text; -webkit-text-fill-color:transparent; text-shadow:0 0 24px rgba(103,232,249,0.26);">Neeti Malu</h1>
    <div style="display:flex; flex-wrap:wrap; justify-content:center; gap:8px; margin-top:10px;">
      <span style="padding:6px 12px; border-radius:999px; background:linear-gradient(90deg, rgba(0,217,255,0.16), rgba(59,130,246,0.14)); color:#67e8f9; font-weight:800; font-size:13px; letter-spacing:0.8px; border:1px solid rgba(103,232,249,0.28);">AI Systems Engineer</span>
      <span style="padding:6px 12px; border-radius:999px; background:linear-gradient(90deg, rgba(124,58,237,0.16), rgba(167,139,250,0.12)); color:#c4b5fd; font-weight:800; font-size:13px; letter-spacing:0.8px; border:1px solid rgba(167,139,250,0.24);">GraphRAG</span>
      <span style="padding:6px 12px; border-radius:999px; background:linear-gradient(90deg, rgba(56,189,248,0.16), rgba(125,211,252,0.12)); color:#7dd3fc; font-weight:800; font-size:13px; letter-spacing:0.8px; border:1px solid rgba(125,211,252,0.24);">Multimodal AI</span>
      <span style="padding:6px 12px; border-radius:999px; background:linear-gradient(90deg, rgba(167,139,250,0.16), rgba(244,114,182,0.10)); color:#ddd6fe; font-weight:800; font-size:13px; letter-spacing:0.8px; border:1px solid rgba(167,139,250,0.24);">Compliance Automation</span>
    </div>
    <p style="margin:14px 0 0; font-size:15px; font-weight:600; font-style:italic; color:#cbd5e1; letter-spacing:1px;">
...
<div style="padding:20px 24px; border:1px solid rgba(103,232,249,0.18); border-left:4px solid #00d9ff; border-radius:18px; background:linear-gradient(90deg, rgba(0,217,255,0.12), rgba(124,58,237,0.07)); box-shadow:0 0 24px rgba(0,217,255,0.08);">
<p style="margin:0 0 12px; font-size:16px; line-height:1.8; color:#f8fafc;">
...
<p style="margin:0; font-size:16px; line-height:1.8; color:#f8fafc;">
